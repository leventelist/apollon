...
--primitive graphical rectangle object, type 6
CREATE TABLE line (
	id INTEGER PRIMARY KEY AUTOINCREMENT,
	name TEXT
);
...
INSERT INTO layer (id, is_outer, is_mirrored, name) VALUES (0, 1, 0, "top");
INSERT INTO layer (id, is_outer, is_mirrored, name) VALUES (31, 1, 1, "bottom");

--silk layers from 32 to 63
--bottom is 32, top is 63

INSERT INTO layer (id, is_outer, is_mirrored, name) VALUES (32, 1, 0, "top silk");
INSERT INTO layer (id, is_outer, is_mirrored, name) VALUES (63, 1, 1, "bottom silk");

--solder mask layers from 64 to 95
--bottom is 64, top is 95
--others make no sence, but I leave it there.

INSERT INTO layer (id, is_outer, is_mirrored, name) VALUES (64, 1, 0, "top mask");
INSERT INTO layer (id, is_outer, is_mirrored, name) VALUES (95, 1, 1, "bottom mask");
